    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
            @if ($categories->isEmpty())
                <div class="bg-white border border-[#E4E0D3] rounded-lg p-6 text-center">
                    <h2 class="text-lg font-semibold text-[#1C1D18] mb-2">No categories yet</h2>
                    <p class="text-sm text-[#6B6A61] mb-4">
                        You need at least one category before you can set a budget limit.
                    </p>
                    <a href="{{ route('categories.index') }}" wire:navigate class="inline-block bg-[#17231F] text-white rounded-md px-4 py-2 text-sm font-medium hover:bg-[#2B372F]">
                        Go to Categories
                    </a>
                </div>
            @else
